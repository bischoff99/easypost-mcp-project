...
# Tests backend API, MCP tools, and supporting services
...
# Rates endpoint is POST-only, skip GET test
...
for file in config/.env config/pytest.ini deploy/docker-compose.yml; do
    if [ -f "$file" ]; then
...
echo "═══════════════════════════════════════════════════════════"
echo "PHASE 6: MCP Tools Verification"
echo "═══════════════════════════════════════════════════════════"
echo ""
