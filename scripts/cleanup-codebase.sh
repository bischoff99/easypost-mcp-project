...
echo "📦 Phase 1: Archiving old reports..."
...
echo ""
echo "📊 Summary:"
echo "  • Archived: 7 old reports"
echo "  • Removed: 2 duplicate files"
echo "  • Organized: 3 temp files"
echo "  • Cleaned: 1 old archive"
echo ""
