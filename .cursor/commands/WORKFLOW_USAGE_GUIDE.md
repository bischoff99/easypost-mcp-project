...
✅ Step 1/6: Explain
   Status: Success
   Understanding: Code structure analyzed
...
**What it does**: Quick project health check
...
1. Tests project health
2. If failures → Fixes issues
3. Commits any fixes
...
**Best for**: Daily startup, quick health checks
...
**What it does**: Final quality check before pushing
...
3. Commits if not already committed
...
**Best for**: Pre-push quality gates, final checks
...
| Morning check    | `morning-routine`  | 20-100s |
...
7. morning-routine - Quick project health check
8. pre-push - Final quality check before pushing
```
